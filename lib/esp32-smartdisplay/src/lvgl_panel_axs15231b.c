...
// JOS : these init-code are NOT used
...
uint16_t flush_cnt = 0; // JOS : keep track of nr of flushes...after last flush, flush_cnt is ZERO
...
// JOS - test rounder function
void rounder_cb(lv_disp_drv_t * disp_drv, lv_area_t * area)
{
    printf("JOS - round x1=%03d, y1=%03d, x2=%03d, y2=%03d\n", area->x1, area->y1, area->x2, area->y2);
    return;
...
void lvgl_lcd_init(lv_disp_drv_t *drv)
{
    ...
    printf("JOS - EXAMPLE_LCD_QSPI_H_RES=%d\n", EXAMPLE_LCD_QSPI_H_RES);
    printf("JOS - EXAMPLE_LCD_QSPI_V_RES=%d\n", EXAMPLE_LCD_QSPI_V_RES);
...
//    drv->rounder_cb = rounder_cb; // JOS
    ...
    max_transfer_sz = sizeof(lv_color_t) * LVGL_BUFFER_PIXELS; // JOS
    ...
    {
      .sclk_io_num = EXAMPLE_PIN_NUM_QSPI_PCLK,
      .data0_io_num = EXAMPLE_PIN_NUM_QSPI_DATA0,
      .data1_io_num = EXAMPLE_PIN_NUM_QSPI_DATA1,
      .data2_io_num = EXAMPLE_PIN_NUM_QSPI_DATA2,
      .data3_io_num = EXAMPLE_PIN_NUM_QSPI_DATA3,
      .data4_io_num = -1,
      .data5_io_num = -1,
      .data6_io_num = -1,
      .data7_io_num = -1,
      .max_transfer_sz = max_transfer_sz,
      .flags = SPICOMMON_BUSFLAG_MASTER // JOS : may also be 0 ?       
    };
...
//    const esp_lcd_panel_io_spi_config_t io_spi_config = AXS15231B_PANEL_IO_QSPI_CONFIG(EXAMPLE_PIN_NUM_QSPI_CS, axs15231b_color_trans_done, drv);
